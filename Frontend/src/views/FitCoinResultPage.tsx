...
import { CheckCircle, Home, ChevronRight, Trophy, Coins, Zap, Star } from 'lucide-react';
...
interface FitCoinResultPageProps {
...
export default function FitCoinResultPage({ mission, missionCount, earnedPoint, totalPoints, streak, onNext, onHome }: FitCoinResultPageProps) {
    ...
    <div style={{ position: 'relative' }}>
      ...
      <div className="fc-card fc-anim-fade" style={{ padding: '14px 16px', marginBottom: 10 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
          <span style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-2)' }}>{missionCount}/3</span>
