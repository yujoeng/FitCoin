...
export default function HomeView({
  ...
  const { points, coins, streakCount, streakDays, character, roomConfig } =
    state;
    ...
    >
      ...
      >
        <div style={{ position: 'relative', flex: 1, minHeight: 0 }}>
          ...
          >
            <CircleButton
              imageSrc='/icons/btn-exchange.png'
              onClick={onGoExchange}
              label='환전소'
            />
            <CircleButton
              imageSrc='/icons/btn-store.png'
              onClick={onGoStore}
              label='상점'
            />
          </div>
          ...
          >
            <CircleButton
              imageSrc='/icons/btn-ad.png'
              onClick={onWatchAd}
              label='광고 시청'
            />
            <CircleButton
              imageSrc='/icons/btn-mission.png'
              onClick={onGoMission}
              label='미션 수행'
            />
          </div>
